...
public class SubscriptionV2 {
    public static void main(String[] args) {
        try
        {
            ...
            NodeId nodeId = NodeId.parse("ns=3;i=1004");
            ...
            UaSubscription.ItemCreationCallback onItemCreated = (sc, item, id) -> item.setValueConsumer(SubscriptionV2::onSubscriptionValue);
